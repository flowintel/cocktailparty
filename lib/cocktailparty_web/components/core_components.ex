defmodule CocktailpartyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CocktailpartyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CocktailpartyWeb.Gettext, "errors", msg, opts)
    end
  end
