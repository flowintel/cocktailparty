defmodule Cocktailparty.UserManagement.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Cocktailparty.Repo)
      |> unique_constraint(:email)
    else
      changeset
    end
  ...
  """
  def valid_password?(%Cocktailparty.Accounts.User{hashed_password: hashed_password}, password)
